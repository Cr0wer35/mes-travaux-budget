...
import { Search, Filter, Receipt, ExternalLink, Trash2, Plus } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {filteredExpenses.length} dépense(s) • Total: {formatCurrency(totalFiltered)}
          </p>
        </div>
        ...
        {filteredExpenses.length === 0 ? (
          <Card className="shadow-card">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-medium mb-2">Aucune dépense trouvée</h3>
          ...
          filteredExpenses.map(expense => (
            <Card key={expense.id} className="shadow-card hover:shadow-primary transition-smooth">
